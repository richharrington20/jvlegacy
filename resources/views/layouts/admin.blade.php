                ...
                @if($account && in_array($account->type_id, [1,2,3]))
                    ...
                    <div class="px-4 mb-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('admin.email-logs.index') }}" class="group relative flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 {{ str_starts_with($currentRoute, 'admin.email-logs') ? 'bg-slate-800/50 text-white' : 'text-slate-300 hover:bg-slate-800/30 hover:text-white' }}">
                                @if(str_starts_with($currentRoute, 'admin.email-logs'))
                                    <div class="absolute left-0 top-0 bottom-0 w-1 bg-teal-400 rounded-r"></div>
                                @endif
